...
This file is intentionally self-contained: every user-facing Telegram message is
rendered here so the runtime has one canonical presentation contract.
"""
...
# Canonical approved signal message family.
...
__all__ = [
    ...
    "trade_closed_message", "msg_start", "msg_scan_started", "msg_scan_result", "msg_balance",
    "msg_summary", "msg_risk", "msg_stats", "msg_weekly", "msg_test", "msg_news_pause",
