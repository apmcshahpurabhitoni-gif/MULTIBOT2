...
def msg_scan_started():return f"🔍 *SCAN STARTED*\n{BR}\n📡 Checking 19 locked live assets\n📈 TrendPulse: 1H signal + confirmed 4H filter\n🔎 Sweep V2: canonical scheduled candles...\n⏳ Please wait for the scan result.\n{BR2}"
