...
def test_signal_send_limit_survives_restart(tmp_path):
    path=tmp_path/"state.db";db=DatabaseManager(str(path));key="TrendPulse|RELIANCE|BUY|2026-08-31T10:15:00+05:30";db.record_signal_send(key,"2026-08-31T10:20:00+05:30","2026-08-31T11:20:00+05:30","message",{"x":1});assert db.signal_count(key)==1
